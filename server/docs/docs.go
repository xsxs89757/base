...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.ConfigRequest"
                        }
                    }
                ],
                "responses": {
                                                ...
                                                },
                                                {
                                                    ...
                                                    "properties": {
                                                        "items": {
                                                            "type": "array",
                                                            "items": {
                                                                "$ref": "#/definitions/admin.ConfigItem"
                                                            }
                                                        }
                                                    }
                                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.DeptRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.MenuRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/system/menu/name-exists": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "当前编辑的菜单ID（编辑模式必传，新增时省略）",
                        "name": "id",
                        "in": "query"
                    }
                ],
        ...
        "/admin/system/operation-log/clear": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                                                ...
                                                },
                                                {
                                                    ...
                                                    "properties": {
                                                        "items": {
                                                            "type": "array",
                                                            "items": {
                                                                "$ref": "#/definitions/admin.OperationLogItem"
                                                            }
                                                        }
                                                    }
                                                }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/admin.UserInfoResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "admin.MenuRequest": {
            ...
            "properties": {
                "activeIcon": {
                    "description": "Vben Admin 路由 meta 装饰字段",
                    "type": "string",
                    "example": ""
                },
                "activePath": {
                ...
                "icon": {
                    "type": "string",
                    "example": "lucide:layout-dashboard"
                },
                "iframeSrc": {
                    "type": "string"
                },
                ...
                "order": {
                    "description": "OrderNo 用指针：区分\"未提交\"和\"显式提交 0\"。\n未提交时 Update 不会重置已有排序值，避免前端少填表单字段就把顺序打乱。",
                    "type": "integer",
                    "example": 1
                },
                "path": {
